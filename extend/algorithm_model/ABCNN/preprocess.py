...
class Word2Vec():
    def __init__(self):
        ...
        # self.model = gensim.models.KeyedVectors.load_word2vec_format('G:/GoogleNews/GoogleNews-vectors-negative300.bin',
                                                                     # binary=True)
        self.model = gensim.models.KeyedVectors.load_word2vec_format('E:/WWW/SourceTree/model/data/wordVec/baike_1.jieba.split.vector',
                                                                     binary=False)
...
class Word2VecZ(object):
    def __init__(self):
        # Load Google's pre-trained Word2Vec model.
        with open("E:/contab/bank.vector", 'r', encoding='utf-8') as f:
            wv = f.read()
        with open("E:/contab/bank.model", 'r', encoding='utf-8') as f:
            dictionary = f.read()
        self.model = wv
